...
namespace P10_Melvin.Database1DataSetTableAdapters {
...
SELECT [Employee ID], Name, Position, [Hourly Pay Rate] FROM Employee WHERE ([Employee ID] = @Employee_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::P10_Melvin.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Update(string Name, string Position, decimal Hourly_Pay_Rate, int Original_Employee_ID, string Original_Name, string Original_Position, decimal Original_Hourly_Pay_Rate, int Employee_ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
